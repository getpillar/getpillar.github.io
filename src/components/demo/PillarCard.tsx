...
export default function PillarCard() {
  return (
    <Card className="p-0 overflow-hidden">
      <div className="relative bg-gradient-to-br from-navy via-navy-light to-navy rounded-xl min-h-[260px] flex flex-col">
        ...
        <div className="absolute inset-0 bg-navy/30 backdrop-blur-[1.5px] rounded-xl flex items-center justify-center">
